 ...
 */
fun <S : ReduxState, A : ReduxAction> Observable<A>.reduxStore2(
    initialState: S,
 ...
 * @see reduxStore
 */
fun <S : ReduxState, A : ReduxAction> Observable<A>.reduxStore(
    initialState: S,
 ...
 */
private class ObservableReduxStore<S : ReduxState, A : ReduxAction>(
    /**
     ...
     */
    private class ReduxStoreObserver<S : ReduxState, A : ReduxAction>(
